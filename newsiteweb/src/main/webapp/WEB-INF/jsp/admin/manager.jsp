...
<head>
    ...
    <link href="${ctx}/css/common/iCheck/all.css" rel="stylesheet" type="text/css" />
    <!-- Theme style -->
    <link href="${ctx}/css/common/style.css" rel="stylesheet" type="text/css" />
</head>
                            ...
                            <ul class="media-list">
                                <li class="media">
                                    <a href="#" class="pull-left">
                                        <img src="${ctx}/image/common/avatar.png" alt="Avatar" class="img-circle" width="64" height="64">
                                    </a>
                    ...
                    <div class="panel">
                        ...
                        <ul class="list-group teammates">
                            <li class="list-group-item">
                                <a href=""><img src="${ctx}/image/common/avatar.png" width="50" height="50"></a>
...
<!-- jQuery UI 1.10.3 -->
<script src="${ctx}/js/common/jquery-ui-1.10.3.min.js" type="text/javascript"></script>
<!-- Bootstrap -->
<script src="${ctx}/js/common/bootstrap.min.js" type="text/javascript"></script>
<!-- daterangepicker -->
<script src="${ctx}/js/plugins/daterangepicker/daterangepicker.js" type="text/javascript"></script>

<script src="${ctx}/js/plugins/chart.js" type="text/javascript"></script>
...
<!-- iCheck -->
<script src="${ctx}/js/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<!-- calendar -->
<script src="${ctx}/js/plugins/fullcalendar/fullcalendar.js" type="text/javascript"></script>

<!-- Director App -->
<script src="${ctx}/js/Director/app.js" type="text/javascript"></script>
